...
#
# Примечание. nn – все ученики, которые поехали на море, mm – все ученики, которые съездили в деревню, и kk – все ученики, которые сходили в горы.
#
#  Sample Input:
#
# 14
...
# m – все ученики, которые съездили в деревню,
# k – все ученики, которые сходили в горы.
# x – все ученики, которые были и в деревне, и на море
# y – все ученики, которые были и в деревне и в горах
# z – все ученики, которые писали ДВИ по математике для поступления в МГУ и никуда не ездили
n,m,k,x,y,z = int(input()), int(input()), int(input()), int(input()), int(input()), int(input())

total_students = z + n + m + k - x - y - 0 + 0
