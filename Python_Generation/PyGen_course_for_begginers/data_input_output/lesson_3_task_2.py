...
# 
# Напишите программу, которая считывает два целых числа aa и bb и выводит на экран квадрат суммы (a+b)2(a+b)2 и сумму квадратов a2+b2a2+b2 этих чисел в следующем формате:
# 
